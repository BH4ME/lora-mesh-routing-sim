...
| `smart-calm-sim-v2` | `release tag` | Timeout-rescue radius follows the active online profile. | 0.962 | 828 | 73496 | 0.932 | 1318 | 122431 |
...
![v2 Unicast PDR](../../results/figures/smart_calm_tags/v2_unicast_pdr.svg)

![v2 Total Airtime](../../results/figures/smart_calm_tags/v2_total_airtime_s.svg)

![v2 Collision Failures](../../results/figures/smart_calm_tags/v2_collision_fail.svg)
