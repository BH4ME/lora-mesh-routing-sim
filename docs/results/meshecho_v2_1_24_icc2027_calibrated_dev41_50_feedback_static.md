...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| meshecho | 0.662 | 0.673 | 23.1 | 7252.0 | 1.78 | 2.8 | 1.000 | 2.12 | 0.700 | 0.039 |
| meshecho-calibrated | 0.694 | 0.696 | 24.8 | 7538.8 | 1.88 | 2.9 | 1.000 | 2.32 | 0.700 | 0.042 |
| prr-product-mesh | 0.688 | 0.690 | 24.7 | 7429.9 | 1.76 | 2.9 | 1.000 | 2.35 | 0.700 | 0.043 |
| meshecho-ack-evict | 0.573 | 0.577 | 27.4 | 9987.5 | 2.28 | 2.3 | 1.000 | 2.12 | 0.649 | 0.039 |
| prr-product-ack-evict-mesh | 0.571 | 0.573 | 27.8 | 9804.0 | 2.38 | 2.3 | 1.000 | 2.27 | 0.643 | 0.042 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| meshecho | 394 | 394 | 4-4 | 4-4 | 268/394 | 273/394 | 0 |
| meshecho-calibrated | 394 | 394 | 4-4 | 4-4 | 281/394 | 282/394 | 0 |
| prr-product-mesh | 394 | 394 | 4-4 | 4-4 | 279/394 | 280/394 | 0 |
| meshecho-ack-evict | 394 | 394 | 4-4 | 4-4 | 231/394 | 233/394 | 0 |
| prr-product-ack-evict-mesh | 394 | 394 | 4-4 | 4-4 | 231/394 | 232/394 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| meshecho | 25.4 | 14.0 | 4.0 | 2.8 | 0.0 | 0.0 | 0.0 | 45.7 | 0.49 |
| meshecho-calibrated | 26.1 | 13.3 | 4.2 | 2.9 | 0.2 | 0.0 | 0.0 | 49.1 | 0.53 |
| prr-product-mesh | 26.1 | 13.3 | 4.2 | 2.9 | 0.2 | 0.0 | 0.0 | 49.0 | 0.51 |
| meshecho-ack-evict | 20.8 | 18.6 | 5.5 | 3.8 | 0.0 | 1.5 | 0.2 | 53.8 | 0.55 |
| prr-product-ack-evict-mesh | 20.8 | 18.6 | 5.5 | 3.6 | 0.2 | 1.3 | 0.1 | 54.6 | 0.60 |
...
| --- | ---: | ---: | ---: |
| meshecho | 40 | 153 | 36 |
| meshecho-calibrated | 42 | 156 | 36 |
| prr-product-mesh | 42 | 156 | 36 |
| meshecho-ack-evict | 55 | 223 | 51 |
| prr-product-ack-evict-mesh | 55 | 208 | 49 |
...
| --- | ---: | ---: | ---: |
| MeshEcho vs meshecho-calibrated | -0.032 [-0.115,+0.052] | -0.023 [-0.107,+0.061] | -1.7 [-3.1,-0.3] |
| MeshEcho vs prr-product-mesh | -0.026 [-0.104,+0.052] | -0.017 [-0.095,+0.061] | -1.6 [-2.8,-0.5] |
